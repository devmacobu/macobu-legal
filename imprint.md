...
## Note on App Distribution

The **Macobu** app is distributed via the Apple App Store (operator: Apple Inc., USA) and the Google Play Store (operator: Google LLC, USA). Apple Inc. and Google LLC are not providers of the app and accept no liability for its content.
...
The content and works created by the provider in this app are subject to German copyright law. Reproduction, editing, distribution and any form of exploitation outside the limits of copyright require the written consent of the respective author.

Book metadata (titles, cover images, descriptions) is sourced from third-party providers (Google Books, Open Library, MangaDex, ComicVine, ISBNdb). The respective copyrights remain with the original owners.

---

## Reporting Security Vulnerabilities (Coordinated Disclosure)
